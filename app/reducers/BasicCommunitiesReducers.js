 ...
 */
import {REQUEST_DATA,RECEIVE_DATA_SUCCESS,RECEIVE_DATA_FAIL} from '../actions/BasicCommunitiesActions'

function BasicCommunitiesReducers(state={},action) {
...
export default BasicCommunitiesReducers